...
#  The test case will pass if the actual output is equal to the expected output and fail otherwise.
# It also tests that the calc function raises a ZeroDivisionError exception when the second argument is zero.
@pytest.mark.parametrize("a, b, expected", [(64, 4, 16), (0, 1, 0), (-100, 100, -1), (-1.1, 1.1, -1.0)])
...
#  The test case will pass if the actual output is equal to the expected output and fail otherwise.
# It also tests that the calc function raises a ZeroDivisionError exception when the second argument is zero.
@pytest.mark.parametrize("ans, b, expected", [(32, 2, 16), (0, 1, 0), (-100, 100, -1), (-2.5, 2.5, -1.0)])
